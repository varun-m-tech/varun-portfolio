...
function Counter({
  ...
  const display = locale ? Math.round(val).toLocaleString() : val.toFixed(decimals);
  ...
  return (
    <div className="relative">
      <div
        ...
        style={{ background: "radial-gradient(ellipse 75% 100% at 30% 30%, rgba(10,14,23,0.65) 0%, transparent 80%)" }}
      />
  ...
  return (
    <>
      ...
      <main className="relative z-10">
        ...
        {/* ── HERO — uses shared HeroSection ──────────────────────────── */}
        <HeroSection
          eyebrow="Senior SDET · QA Automation · Bangalore, India"
          heading={
            <>
              Quality,
              <br />
          ...
          headingClassName="text-5xl font-semibold leading-[0.95] tracking-tight sm:text-7xl lg:text-8xl"
          meta={
            <p className="text-xs text-white/35" style={{ fontFamily: "var(--font-mono)" }}>
              <a href="mailto:varunm.work1@gmail.com" className="transition-colors hover:text-white/60">
          ...
          body="I'm Varun — a Senior SDET with nearly seven years of professional testing since 2019, and just as long teaching. I build automation that catches what people miss, and I've never stopped explaining how."
          ctas={
            <>
              <MagneticButton href="/sdet" variant="solid">View Work</MagneticButton>
              <MagneticButton href="/resume" variant="ghost">Résumé</MagneticButton>
            </>
          }
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 lg:grid-cols-6 lg:gap-2">
              {METRICS.map((m, i) => (
                ...
                >
                  <div style={{ fontFamily: "var(--font-serif)" }} className="text-3xl font-semibold text-[#D8B450] sm:text-4xl">
                    <Counter
                      to={m.to}
              ...
              {CAREER_CARDS.map((card, i) => (
                ...
                >
                  <div className="mb-5 flex items-center gap-3">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg" style={{ background: `${card.accent}22`, color: card.accent }}>
                      {card.icon}
                    </div>
                    <h3 style={{ fontFamily: "var(--font-serif)" }} className="text-xl font-semibold">{card.title}</h3>
                  </div>
                  <p className="mb-5 text-sm leading-relaxed text-white/60">{card.body}</p>
                  <ul className="space-y-2">
                    {card.bullets.map((b) => (
                      <li key={b} className="flex items-start gap-2 text-xs text-white/45">
                        <span className="mt-1 h-1 w-1 shrink-0 rounded-full" style={{ background: card.accent }} />
                        {b}
                      </li>
                    ))}
                  </ul>
        ...
        {/* ── ABOUT GLANCE ─────────────────────────────────────────────── */}
        <section id="about" className="relative overflow-hidden py-20 md:flex md:items-center" style={{ minHeight: "680px" }}>

          {/* Desktop: hero-style portrait filling left side */}
          <motion.div
          ...
          >
            <Image
              ...
              sizes="46vw"
            />
            {/* Right-edge fade — narrower so portrait reads clearly */}
            <div className="absolute inset-y-0 right-0 w-[38%] bg-gradient-to-l from-[#0A0E17] to-transparent" />
            <div className="absolute top-0 inset-x-0 h-[12%] bg-gradient-to-b from-[#0A0E17]/70 to-transparent" />
            <div className="absolute bottom-0 inset-x-0 h-[15%] bg-gradient-to-t from-[#0A0E17]/70 to-transparent" />
          </motion.div>
          ...
          <div className="relative mx-auto w-full max-w-6xl px-6">
            ...
            {/* Bio — pushed right on desktop, slightly overlapping the portrait */}
            <motion.div
            ...
            >
              <div
                ...
                style={{ background: "radial-gradient(ellipse 90% 90% at 60% 50%, rgba(10,14,23,0.60) 0%, transparent 85%)" }}
              />
              <p className="relative mb-3 text-xs uppercase tracking-[0.22em] text-[#38BDF8]">About</p>
              <h2 style={{ fontFamily: "var(--font-serif)" }} className="relative mb-5 text-4xl tracking-tight sm:text-5xl">
                From the classroom
                <br />
        ...
        <section id="cta" className="relative py-20 border-t border-b border-white/[0.07]">
          ...
          <div aria-hidden className="pointer-events-none absolute inset-0" style={{ background: "radial-gradient(ellipse 60% 90% at 50% 50%, rgba(10,14,23,0.65) 0%, transparent 85%)" }} />
        ...
        <section id="contact" className="relative py-28">
          <div aria-hidden className="pointer-events-none absolute inset-0" style={{ background: "radial-gradient(ellipse 55% 75% at 50% 50%, rgba(10,14,23,0.60) 0%, transparent 80%)" }} />
          <div className="relative mx-auto max-w-6xl px-6 text-center">
            <h2 style={{ fontFamily: "var(--font-serif)" }} className="text-4xl tracking-tight sm:text-5xl">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <MagneticButton href="mailto:varunm.work1@gmail.com" variant="solid">Email me</MagneticButton>
              <MagneticButton href="https://linkedin.com/in/varun-m-78a106294" variant="ghost">LinkedIn</MagneticButton>
            </div>
          </div>
        </section>
      </main>
