...
export default function SdetContent() {
  return (
    <main className="relative z-10 min-h-screen">
      ...
      {/* ── HERO ──────────────────────────────────────────────────── */}
      <HeroSection
        eyebrow="Software · SDET"
        heading={
          <>
            I build automation
            <br />
            <span className="italic text-[#D8B450]">that scales.</span>
          </>
        }
        body="Senior SDET at Cyware Labs — building Python/Pytest frameworks and CI pipelines for cybersecurity products. Nearly seven years across cybersecurity, banking, fintech, logistics, and edtech, all under Test Yantra Software Solutions since Aug 2019."
        ctas={
          <>
            <PageLink href="/resume" variant="solid">Résumé</PageLink>
            <PageLink href="/contact" variant="ghost">Get in touch</PageLink>
          </>
        }
        imageSrc="/assets/sdet-hero.webp"
        imageAlt="Varun M — SDET"
